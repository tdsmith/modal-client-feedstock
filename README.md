...
pixi add modal-client
# for installing globally
pixi global install modal-client
```
...
It is possible to list all of the versions of `modal-client` available on your platform:
...
```
pixi search modal-client --channel conda-forge
```
